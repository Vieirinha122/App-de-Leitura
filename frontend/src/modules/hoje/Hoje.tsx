...
export default function HojePlaceholder() {
  return (
    <div className="container-narrow py-12 text-center">
      ...
      <h2 className="font-display text-display-md text-ink-900 mb-3">Hoje</h2>
      <p className="text-body-lg text-ink-500 mb-6 max-w-prose mx-auto">
        Leitura diária recomendada — em desenvolvimento (ONDA 2)
      </p>
